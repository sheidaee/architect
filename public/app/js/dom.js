angular.module('builder')
    .factory('dom', ['$rootScope', 'undoManager', 'elements', 'themes', function($rootScope, undoManager, elements, themes) {
        ...
        var dom = {
             ...
             * @return string
             */
            getHtml: function(page, includeCss, includeJs) {
                ...
                head += '<link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet">';

                if (page) {
                    var path = themes.get(page.theme) ? themes.get(page.theme).path : $rootScope.baseUrl+'/css/bootstrap.min.css';
                ...
                if (includeJs) {
                    body += '<script src="js/vendor/jquery.js"></script>';
                    body += '<script src="js/vendor/bootstrap/bootstrap.min.js"></script>';

                    if (page && page.libraries) {
                        for (var i = 0; i < page.libraries.length; i++) {
                            body += '<script src="'+ page.libraries[i].path +'"></script>';
                        };
                    }

                    if (page && page.js) {
                        body += '<script>'+page.js+'</script>';
                    }
                }
