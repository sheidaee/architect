angular.module('builder.elements')
    ...
    .factory('elements', ['$rootScope', '$http', '$state', 'draggable', function($rootScope, $http, $state, draggable) {
        ...
        var repo = {
            ...
            * @return void
            */
            match: function(node, type, matchParent) {
            ...
            addElement: function(config) {
                ...
                if (el.canDrag) {
                    var description = el.camelName+'Desc',

                    //compile list item html with description or without
                        html = '<li data-name="'+el.name+'" data-frameworks="'+el.frameworks.toString()+'">'+
                            '<div class="el-list-item">'+el.camelName+'<p class="el-description">'+(description == el.camelName+'Desc' ? '' : description)+'</p></li>';
